        ...
        try {
            ...
            if ((line = br.readLine()) != null) {
                ...
                if (noIcon.equals("noIcon")) {
                    ...
                    ComponentName componentName = new ComponentName(this, com.lovejoy777.rommate.MainActivity.class); // activity which is first time open in manifiest file which is declare as <category android:name="android.intent.category.LAUNCHER" />
